...
Notar que es una visualización interactiva y que hay unos círculos con números. Este número corresponde a la cantidad de locales que hay en la zona. Si hacemos click, hará zoom en esa zona y creará nuevos grupos. Si hacemos click sucesivamente, podremos ver a qué locales corresponden. Si pinchamos en el local, podremos ver información relativa a ellos.
...
El mapa también cuenta con cuatro botones en la esquina superior izquierda. Los dos primeros son para hacer más y menos zoom; el tercero es para regresar a la vista inicial y el último es para buscar y situar la vista en el sensor que queramos.

Si se hace click en un sensor, también se muestra información relativa a sus datos.

Es recomendable probar a interactuar con el mapa.