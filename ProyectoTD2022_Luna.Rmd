...
```{r}
all_df %>% summarise(minimo_LAeq = min(all_df[,2]),minimo_LAeq_d=min(all_df[,3]),
...
alarma %>% summarise(media_alarma_LAeq=mean(alarma$LAeq),
...
no_alarma %>% summarise(media_no_alarma_LAeq=mean(no_alarma$LAeq),
...
madm <- function(x, na.rm=T) { 
  1.4826*quantile(abs(x-quantile(x,0.5,na.rm)),0.5,na.rm)
}
...
sort(all_df2$LAeq[all_df2$LAeq_reglasigma],decreasing=T)
sort(all_df2$LAeq[all_df2$LAeq_reglasigma],decreasing=T)
sort(all_df2$LAeq[all_df2$LAeq_reglasigma],decreasing=T)
sort(all_df2$LAeq[all_df2$LAeq_reglasigma],decreasing=T)
...
sort(all_df3$LAeq_d[all_df3$LAeq_d_reglasigma],decreasing=T)
sort(all_df3$LAeq_d[all_df3$LAeq_d_reglasigma],decreasing=T)
sort(all_df3$LAeq_d[all_df3$LAeq_d_reglasigma],decreasing=T)
sort(all_df3$LAeq_d[all_df3$LAeq_d_reglasigma],decreasing=T)
...
sort(all_df4$LAeq_den[all_df4$LAeq_den_reglasigma],decreasing=T)
sort(all_df4$LAeq_den[all_df4$LAeq_den_reglasigma],decreasing=T)
sort(all_df4$LAeq_den[all_df4$LAeq_den_reglasigma],decreasing=T)
sort(all_df4$LAeq_den[all_df4$LAeq_den_reglasigma],decreasing=T)
...
sort(all_df5$LAeq_e[all_df5$LAeq_e_reglasigma],decreasing=T)
sort(all_df5$LAeq_e[all_df5$LAeq_e_reglasigma],decreasing=T)
sort(all_df5$LAeq_e[all_df5$LAeq_e_reglasigma],decreasing=T)
sort(all_df5$LAeq_e[all_df5$LAeq_e_reglasigma],decreasing=T)
...
sort(all_df6$LAeq_n[all_df6$LAeq_n_reglasigma],decreasing=T)
sort(all_df6$LAeq_n[all_df6$LAeq_n_reglasigma],decreasing=T)
sort(all_df6$LAeq_n[all_df6$LAeq_n_reglasigma],decreasing=T)
sort(all_df6$LAeq_n[all_df6$LAeq_n_reglasigma],decreasing=T)
```
